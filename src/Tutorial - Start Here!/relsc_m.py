...
class RelSCM(InMemoryDataset):
    ...
    **STATS:**
    ...
    def processed_file_names(self):
        return [f'data_heterogeneous_{self.project_name}.pt', f'split_heterogeneous_{self.project_name}.pt']
    ...
    def process(self):
        ...
        for key in sorted_keys:
            ...
            for k_edge in edge_index_dict:
                data[k_edge].edge_index = torch.tensor(edge_index_dict[k_edge], dtype=torch.long).t().contiguous()
